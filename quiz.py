...
def loginPage(logdata):
    ...
    login_canvas = Canvas(login,width=720,height=440,bg="#54C6BE")
    login_canvas.pack()

    login_frame = Frame(login_canvas,bg="#F7B15C")
    login_frame.place(relwidth=0.8,relheight=0.8,relx=0.1,rely=0.1)

    heading = Label(login_frame,text="Quiz App Login",fg="white",bg="#E5243F")
    heading.config(font=('calibri 40'))
    heading.place(relx=0.2,rely=0.1)

    #USER NAME
    ulabel = Label(login_frame,text="Username",fg='white',bg='#E5243F')
    ...
    #PASSWORD
    plabel = Label(login_frame,text="Password",fg='white',bg='#E5243F')
    ...
    #LOGIN BUTTON
    log = Button(login_frame,text='Login',padx=5,pady=5,width=5,command=check,fg="white",bg="#4357AD")
...
def signUpPage():
    ...
    sup_canvas = Canvas(sup,width=720,height=440,bg="#54C6BE")
    sup_canvas.pack()

    sup_frame = Frame(sup_canvas,bg="#F7B15C")
    sup_frame.place(relwidth=0.8,relheight=0.8,relx=0.1,rely=0.1)

    heading = Label(sup_frame,text="Quiz App SignUp",fg="WHITE",bg="#F65C51")
    heading.config(font=('calibri 40'))
    heading.place(relx=0.2,rely=0.1)

    #full name
    flabel = Label(sup_frame,text="Full Name",fg='white',bg='#E5243F')
    ...
    #username
    ulabel = Label(sup_frame,text="Username",fg='white',bg='#E5243F')
    ...
    #password
    plabel = Label(sup_frame,text="Password",fg='white',bg='#E5243F')
    ...
    #country
    clabel = Label(sup_frame,text="Country",fg='white',bg='#E5243F')
    ...
    #signup BUTTON
    sp = Button(sup_frame,text='SignUp',padx=5,pady=5,width=5,command = addUserToDataBase, bg="#4357AD",fg="white")
    sp.configure(width = 15,height=1, activebackground = "#54C6BE", relief = FLAT)
    sp.place(relx=0.4,rely=0.8)

    log = Button(sup_frame,text='Already have a Account?',padx=5,pady=5,width=5,command = gotoLogin,bg="#4357AD", fg="white")
...
def menu(abcdefgh):
    ...
    menu_canvas = Canvas(menu,width=720,height=440,bg="#54C6BE")
    menu_canvas.pack()
...
def easy():
    ...
    easy_canvas = Canvas(e,width=720,height=440,bg="#54C6BE")
    easy_canvas.pack()

    easy_frame = Frame(easy_canvas,bg="#F7B15C")
    ...
    ques = Label(easy_frame,text =easyQ[x][0],font="calibri 12",bg="#F2B705")
